...
#define MSG_TP_IC_NAME "msg2836_ts" //"msg22xx" or "msg28xx" /* Please define the mstar touch ic name based on the mutual-capacitive ic or self capacitive ic that you are using */
...
static int /*__init*/ touch_driver_init(void)
{
	...
	if (in_calibration()) {
		printk("add ILITEK/MStar touch probe cali_mode_tp\n");
 		if (gpio_request(145, "ilitek_reset")) {
