...
#define VENDOR_PSC5415					(0x7)
#define REV_CODE_PSC5415E       (0x0)
#define REV_CODE_PSC5415Z       (0x6)
...
#define FAN5405_REG_CURMAX              (0x51)
...
#define FAN5405_TMR_RST_OTG			(0x01 << 7)
...
#define FAN5405_CUR				(0x01 << 0)
#define FAN5405_CUR_SHIFT			(0)
...
#define FAN5405_REV_CODE		(0x0F << 0)
#define FAN5405_REV_CODE_SHIFT	(0)
...
#define PSC5415Z_ADD20MV				(0X01 << 7)
#define PSC5415Z_ADD20MV_SHIFT				(7)
...
extern void fan54015_set_vindpm(unsigned char reg_val);
extern void fan54015_termina_cur_set(unsigned char reg_val);
extern void fan54015_termina_vol_set(unsigned char reg_val);
extern void fan54015_set_safety_vol(unsigned char reg_val);
extern void fan54015_set_safety_cur(unsigned char reg_val);
extern void fan54015_init(void);
extern void fan54015_otg_enable(int enable);
extern void fan54015_stop_charging(void);
extern unsigned char fan54015_get_vendor_id(void);
extern unsigned char fan54015_get_rev_code(void) ;
extern unsigned char fan54015_get_chg_status(void);
extern unsigned char fan54015_get_fault_val(void);
extern void fan54015_enable_chg(void);
extern void fan54015_set_chg_current(unsigned char reg_val);
extern unsigned char fan54015_get_chg_current(void);
