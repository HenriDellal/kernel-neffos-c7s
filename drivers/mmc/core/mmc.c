...
static struct memory_type sprocomm_memtype[] = {
    {"TA2832","Kingston EMMC32G-TA28"},
    {"TB2816","Kingston EMMC16G-TB28"},
	{"TB2832","Kingston EMMC32G-TB28"},
    {"TA2816","Kingston EMMC16G-TA28"},
	{"TA2864","Kingston EMMC64G-TB28"},
	{"TB2864","Kingston EMMC64G-TB28"},
};
static ssize_t mmc_memorytype_show (struct device *dev, struct device_attribute *attr, char *buf)
{
    uint32_t i;
    uint32_t count;
...
static DEVICE_ATTR(memory_type, S_IRUGO, mmc_memorytype_show, NULL);
...
static int mmc_select_timing(struct mmc_card *card)
{
	...
	if ((card->mmc_avail_type & EXT_CSD_CARD_TYPE_HS400ES) &&
	    (card->host->caps2 & MMC_CAP2_HS400_ES))
	...
	struct mmc_card *oldcard)
{
	...
	host->mmc_ext_csd_rev = card->ext_csd.rev;
	/*
