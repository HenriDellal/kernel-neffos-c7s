...
static const struct cts_flash cts_flashes[] = {
    /* Winbond */
    { "Winbond,W25Q10EW", 0xEF6011, 256, 0x1000, 0x8000, 0x20000},
    { "Winbond,W25Q20EW", 0xEF6012, 256, 0x1000, 0x8000, 0x40000},

    /* Giga device */
    { "Giga,GD25LQ10B",0xC86011, 256, 0x1000, 0x8000, 0x20000},
    { "Giga,GD25LQ40B",0xC86013, 256, 0x1000, 0x8000, 0x80000},
    { "Giga,GD25LD20CEIGR",0xC86012, 256, 0x1000, 0x8000, 0x40000},
    { "Giga,GD25LD40CEIGR",0xC86013, 256, 0x1000, 0x8000, 0x80000},

    /* Macronix */
    { "Macronix,MX25U1001E", 0xC22531, 32, 0x1000, 0x10000, 0x20000},
    { "Macronix,MX25R2035F", 0xC22812, 256, 0x1000, 0x8000,  0x40000},

    /* Puya-Semi */
    { "Puya-Semi,P25Q20LUVHIR", 0x856012, 256, 0x1000, 0x8000, 0x40000},
    { "Puya-Semi,P25Q40LUXHIR", 0x856013, 256, 0x1000, 0x8000, 0x80000},

    /* EON */
    { "EON,EN25S20A", 0x1c3812, 256, 0x1000, 0x8000, 0x40000},
    
    /* Xinxin-Semi */
    { "Xinxin-Semi,XM25QU20B", 0x205012, 256, 0x1000, 0x8000, 0x40000},
    /* XTXTECH */
    { "XTXTECH,XT25Q02DDFIGT", 0x0b6012, 256, 0x1000, 0x10000, 0x40000},
