...
static int32_t mipi_panel_push_specificode(struct panel_device *pd)
{
...
//    mipi_dsi_lp_cmd_enable(dsi, true);
    ...
    mipi_dsi_send_cmds(dsi, panel->cmd_codes[CMD_CODE_SLEEP_OUT]);

 //   mipi_dsi_set_work_mode(dsi, DSI_MODE_VIDEO);
...
struct panel_ops panel_ops_mipi = {
	...
	.specificode_push = mipi_panel_push_specificode,
