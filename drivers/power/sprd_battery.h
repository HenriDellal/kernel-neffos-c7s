...
/*********************************/
#define CONFIG_SPROCOMM_EXHIBITION_MODE
#ifdef CONFIG_SPROCOMM_EXHIBITION_MODE
#define EXHIBITION_NORMAL_CV		4200
#define EXHIBITION_HIGH_TEMP_CV	4200
#define EXHIBITION_NORMAL_VORG		4000
#define EXHIBITION_HIGH_TEMP_VORG	3800
#define EXHIBITION_CHANGE_CV_TEMP 450

struct tplink_charger {
	int exhibition_mode;
	int is_timeout;
	int is_limit_cur;
	int vrechg;
...
struct sprd_battery_platform_data {
	...
	void *ext_data;
	/*PSC5415A rsensor flag; 0:56mohm; 1:33mohm*/
	int psc5415a_rsense;
};
