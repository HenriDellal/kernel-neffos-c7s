...
extern struct tplink_charger chg_setting;
#endif

void fan54015_init(void)
{
	unsigned char rev_code = 0, vendor_id = 0;

	SPRD_EX_DEBUG("fan54015_init\n");
	fan54015_set_value(FAN5405_REG_SAFETY, FAN5405_VSAFE,FAN5405_VSAFE_SHIFT, VSAFE4P40); // VSAFE = MAX
	fan54015_set_value(FAN5405_REG_SAFETY, FAN5405_ISAFE, FAN5405_ISAFE_SHIFT, ISAFE1450);// ISAFE = MAX
	//fan54015_set_value(FAN5405_REG_CONTROL1, FAN5405_IINLIM, FAN5405_IINLIM_SHIFT,NOLIMIT);  // INLIM =MAX
	fan54015_set_value(FAN5405_REG_CURMAX, FAN5405_CUR, FAN5405_CUR_SHIFT,IINLIM500); //CURRENT_CHOOSE
	//fan54015_set_value(FAN5405_REG_CONTROL1, FAN5405_TE, FAN5405_TE_SHIFT, ENTE);  // Iterm on
	//fan54015_set_value(FAN5405_REG_SP_CHARGER, FAN5405_VSP, FAN5405_VSP_SHIFT, VSP4P613); 
	...
	if ((vendor_id == VENDOR_PSC5415)&&(rev_code == REV_CODE_PSC5415Z)) {
		if (1 == chg_setting.exhibition_mode){
		     fan54015_set_value(FAN5405_REG_SP_CHARGER, PSC5415Z_ADD20MV, PSC5415Z_ADD20MV_SHIFT, 0);
		}else{
			 fan54015_set_value(FAN5405_REG_SP_CHARGER, PSC5415Z_ADD20MV, PSC5415Z_ADD20MV_SHIFT, 1);
		}
	}
...
unsigned char fan54015_get_rev_code(void)
{
	return fan54015_get_value(FAN5405_REG_IC_INFO,
				  FAN5405_REV_CODE,
				  FAN5405_REV_CODE_SHIFT);
}
...
static void fan54015_shutdown(struct i2c_client *client)
{
