...
static const struct {
	...
	{ 3,	ACCEL_GRP4_ODR800 },
	{ 5,	ACCEL_GRP4_ODR400 },
	{ 10,	ACCEL_GRP4_ODR100 },/*ACCEL_GRP4_ODR200*/
...
static ssize_t g_sensor_cali_read(struct file *file, char __user *buf, size_t size,  loff_t *ppos)
{
	int i = 0;
	int j = 0;
...
static DEVICE_ATTR(data, 0660, kionix_accel_get_data, NULL);
static DEVICE_ATTR(cali, 0660, kionix_accel_get_cali, kionix_accel_set_cali);
static DEVICE_ATTR(vendor_name, 0660, kionix_accel_name_show, NULL);
